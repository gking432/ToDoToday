...
export function MobileBottomNav({ activeTab, onTabChange }: MobileBottomNavProps) {
  ...
  const inactiveColor = inverted ? colors.primary : colors.navText
        ...
        return (
          <button
            ...
            style={{
              ...
              border: isActive ? 'none' : `1.5px solid ${colors.navBorder}`,
              borderRadius: '10px',
            ...
            {isActive && (
              <span
                style={{
                  ...
                  fontSize: '11px',
                  fontWeight: 600,
                  color: isActive ? colors.navText : inactiveColor,
                  marginBottom: '4px',
                  lineHeight: 1,
                }}
              >
